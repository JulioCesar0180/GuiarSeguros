    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('building', models.ManyToManyField(blank=True, null=True, to='Poll.BuildingProcess')),
                ('city', models.ForeignKey(null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='Home.city')),
                ('general_services', models.ManyToManyField(blank=True, null=True, to='Poll.GeneralServicesProcess')),
                ...
                ('manufacture', models.ManyToManyField(blank=True, null=True, to='Poll.ManufactureProcess')),
                ('process', models.ManyToManyField(blank=True, null=True, to='Poll.ProcessBusiness')),
                ...
                ('transport', models.ManyToManyField(blank=True, null=True, to='Poll.TransportProcess')),
